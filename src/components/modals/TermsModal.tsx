  ...
  useEffect(() => {
    if (isOpen) {
      ...
      loadGsap().then(({ gsap }) => {
        ...
        if (panelRef.current)
          tl.to(panelRef.current, { opacity: 0, scale: 0.95, y: 20, duration: 0.2 }, 0);
      });
      return () => {
        active = false;
      };
        ...
        <div className="fixed inset-0 z-[501] flex items-center justify-center p-4 sm:p-0 pointer-events-none">
          ...
          >
            <div
              ...
              className="bg-card border border-border rounded-2xl shadow-2xl overflow-hidden flex flex-col max-h-[85vh]"
            >
              {/* Header */}
              ...
              {/* Content */}
              <div
                className="p-6 overflow-y-auto custom-scrollbar space-y-6 text-sm text-foreground/80 leading-relaxed"
              ...
              >
                <section>
                  ...
                  <p>{t('terms_modal.section1_text')}</p>
                </section>
                ...
                <section>
                  ...
                  <p>{t('terms_modal.section2_text')}</p>
                ...
                <section>
                  ...
                  <p>{t('terms_modal.section3_text')}</p>
                </section>
                ...
                <section>
                  ...
                  <p>{t('terms_modal.section4_text')}</p>
                </section>
              </div>
