...
export function Contact() {
    ...
    // Text guide path: north shore shifted up by 14 units for "floating" text
    const shoreNorthTextGuide =
        'M 0 106 C 4.6 100.5 8.6 82.8 29 71.7 C 49.4 60.6 106.1 42.4 127.2 36.6 C 148.3 30.8 152.1 37.6 161.1 35.4 C 170.1 33.2 168.5 27 183.2 22.6 C 197.9 18.2 230.2 10.2 252.9 8 C 275.6 5.8 303.8 9.7 324.8 8.9 C 345.8 8.1 362.4 6.7 383.9 3.2 C 405.4 -0.3 437.2 -10.9 459.2 -13 C 481.2 -15.1 504.3 -9.6 521.3 -9.8 C 538.3 -10 540.7 -14.2 565.4 -14 C 590.1 -13.8 648.7 -10.6 675.5 -8.6 C 702.3 -6.6 712.4 -3.5 733.2 -1.6 C 754 0.3 782.8 2 805.2 3.1 C 827.6 4.2 856.2 3.7 872.9 5.4 C 889.6 7.1 894.5 11.7 909.5 13.5 C 924.5 15.3 954.1 15.5 966.9 16.8 C 979.7 18.1 984.2 20 989.5 21.7 C 994.8 23.4 998.2 26.7 999.9 27.6';
            ...
            <div className="max-w-4xl mx-auto">
                ...
                <div className="px-px relative">
                    ...
                    >
                        ...
                        >
                            <textPath href="#shoreTextGuide" startOffset="50%" textAnchor="middle">
